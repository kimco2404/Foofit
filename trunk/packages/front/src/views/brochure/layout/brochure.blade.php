        ...
        <div class="container top-menu">
            ...
            <div class="navbar-collapse ">
                <ul class="nav navbar-nav navbar-right collapse collapse-top-menu"> 
                    <li class="item active"><a href="{{route('tintuc')}}">TIN TỨC</a></li>
                    <li class="item"><a href="{{route('giangvien')}}">GIẢNG VIÊN</a></li>
                    <li class="item"><a href="{{route('sinhvien')}}">SINH VIÊN</a></li>
                    <li class="item"><a href="{{route('chuyende')}}">CHUYÊN ĐỀ</a></li>
                    <li class="item"><a href="{{route('daotao')}}">ĐÀO TẠO</a></li>
                </ul>
            </div>
            <!--END MAIN MENU--> 
        </div>
        ...
        <div class="container training">
            <div class="container brochure">
                <div class="row">
                    ...
                    <div class="flipbook-viewport" style="background:url('{{asset('front/images/iTDCcatalog_print2.jpg')}}');">
                        <div class="container_mag">
                            <div class="flipbook">
                                <div style="background-image:url({{asset('front/images/iTDCcatalog_print2.jpg')}}})"></div>
