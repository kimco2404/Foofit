    ...
    <div class="container news">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="front/images/posts-1.png" alt=""/>
                    </div>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">                   
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="front/images/posts-3.jpg" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="front/images/posts-4.png" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="front/images/posts-5.jpg" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">                   
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="front/images/posts-6.jpg" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
