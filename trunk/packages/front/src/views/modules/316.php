            ...
            <div class="col-sm-8 col-md-8 prof_list">
                <div class="row">
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/LamThiPhuongThao.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/NguyenThiVan.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/PhanThiTrinh.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/MaiKyTuyen.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/HuynhThiPhuongThuy.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/NgoThiAnhThu.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/HoangCongTrinh.jpg" alt=""/>
                            </div>
                        </div>
