            ...
            <div class="col-sm-8 col-md-8 prof_list">
                <div class="row">
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/TranThiMinhSa.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/NguyenNgocCamTu.jpg" alt=""/>                  
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/NguyenPhongLan.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/DoanQuocThuan.jpg" alt=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="front/images/HoangAnh.jpg" alt=""/>
                            </div>
                        </div>
