    ...
    <div class="container top-menu">
        ...
        <div class="menu">
            <ul class="nav-menu collapse collapse-top-menu">
                <li class="item active"><a href="{{route('trangchu')}}"> Trang Chủ </a></li>
                ...
                <div class="row maincontent">
                    <div class="col-md-12">
                        ...
                        <div style="text-align: center;">
                            <img src="{{asset('front/images/tdc-1.jpg')}}" alt=""/>
                        </div>
                        &nbsp;

                        <div style="text-align: center;">
                            <img src="{{asset('front/images/tdc-2.jpg')}}" alt=""/>
                        </div>
                        <div style="text-align: center;">
                        ...
                        <div style="text-align: center;">
                            <img src="{{asset('front/images/tdc-3.jpg')}}" alt=""/>
                        </div>
                        ...
                        <br>
                        <img src="{{asset('front/images/tdc-7.jpg')}}" alt=""/>
                        <div style="text-align: center;">
                        ...
                        <img src="{{asset('front/images/tdc-8.jpg')}}" alt=""/>
                        <br>
                        <br>
                        ...
                        <br>
                        <img src="{{asset('front/images/tdc-9.jpg')}}" alt=""/>
                        <br>
                        <br>
                        ...
                        <img src="{{asset('front/images/tdc-10.jpg')}}" alt=""/>
                        <div style="text-align: center;">
                            <em>Phòng thực hành&nbsp;Quản trị mạng</em>
                        </div>
                        <br>

                        <img src="{{asset('front/images/tdc-11.jpg')}}" alt=""/>
                        <div style="text-align: center;">
                            <em>Giờ thực hành chuyên ngành Truyền thông đa phương tiện</em>
                        </div>
                        <br>

                        <img src="{{asset('front/images/tdc-12.jpg')}}" alt=""/>
                        <div style="text-align: center;">
                            <em>Giờ học lý thuyết</em>
                        </div>
                        <br>

                        <img src="{{asset('front/images/tdc-13.jpg')}}" alt=""/>
                        <div style="text-align: center;">
                            <em>Giờ tự học của sinh viên tại thư viện</em>
                        </div>
                        <br>

                        <img src="{{asset('front/images/tdc-14.jpg')}}" alt=""/>
                        <div style="text-align: center;">
                        ...
                        <div class="panel panel-default list_departments">
                            ...
                            <div class="dep_list">
                                <div class="dep_item dep_network">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <img class="img-responsive" src="{{asset('front/images/mmt_thumb.jpg')}}">
                                        </div>
                                ...
                                <div class="dep_item dep_software">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <img class="img-responsive" src="{{asset('front/images/cnpm_thumb.jpg')}}">
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 dep_name">
                                ...
                                <div class="dep_item dep_graphic">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <img class="img-responsive" src="{{asset('front/images/dh_thumb.jpg')}}">
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 dep_name">
                                            Đồ họa
                                        </div>
                                ...
                                <div class="dep_item dep_informatics">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <img class="img-responsive" src="{{asset('front/images/thcs_thumb.jpg')}}">
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 dep_name">
                                            Tin học<br>cơ sở
                                        </div>
