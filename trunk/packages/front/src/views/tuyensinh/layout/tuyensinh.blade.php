...
<div class="type-330">
    ...
    <div class="container">
        ...
        <!--IMAGES-->
        <div>
            <img src="{{asset('front/images/tdcwhyus.gif')}}" alt="tdc-tuyensinh-2015" style="width: 100%; max-width: 100%;">
            <img src="{{asset('front/images/tdc-tuyensinh.gif')}}" alt="tdc-tuyensinh-2015-tong-quan" style="width: 100%; max-width: 100%;">
        </div>
    </div>
    <!--END OF HEADER-->
</div>
