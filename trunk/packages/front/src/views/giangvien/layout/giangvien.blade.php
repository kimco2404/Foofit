...
<div class="type-343">
                    ...
                    <div class="col-sm-8 col-md-8 prof_list">
                        <div class="row">
                            <div class="col-xs-6 col-sm-3 placeholder profview">
                                <div class="profview_thumb">
                                    <div class="profview_thumb_wrap">
                                        <img src="{{asset('front/images/VoThanhTrung.jpg')}}" alt=""/>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-6 col-sm-3 placeholder profview">
                                <div class="profview_thumb">
                                    <div class="profview_thumb_wrap">
                                        <img src="{{asset('front/images/TieuKimCuong.jpg')}}" alt=""/>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-6 col-sm-3 placeholder profview">
                                <div class="profview_thumb">
                                    <div class="profview_thumb_wrap">
                                        <img src="{{asset('front/images/NguyenHongLan.png')}}" alt=""/>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-6 col-sm-3 placeholder profview">
                                <div class="profview_thumb">
                                    <div class="profview_thumb_wrap">
                                        <img src="{{asset('front/images/DongThiHoan.jpg')}}" alt=""/>
                                    </div>
                                </div>
                ...
                <div class="col-sm-8 col-md-8 prof_list">
                    <div class="row">
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/LamThiPhuongThao.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/NguyenThiVan.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/PhanThiTrinh.jpg')}}" alt=""/>
                                </div>
                            </div>
                            <h4 class="prof_name"><a href="http://fit.tdc.edu.vn/nhan-su/nguyen-thi-van">Nguyễn Thị Vân</a></h4>
                            <span class="prof_title">Giảng viên</span>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/HuynhThiPhuongThuy.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/NgoThiAnhThu.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/HoangCongTrinh.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/PhanThanhNhuan.png')}}" alt=""/>
                                </div>
                            </div>
                            <h4 class="prof_name"><a href="http://fit.tdc.edu.vn/nhan-su/phan-thanh-nhuan">Hoàng Công Trình</a></h4>
                            <span class="prof_title">Giảng viên</span>
                        </div>
    ...
    <div class="type-316">
        <div class="container teacher">
            <div class="row">
                <!--SOFTWARE TECHNOLOGY (C�NG NGH? PH?N M?M)-->
                <div class="col-sm-4 col-md-4">
                    <div class="widget html">
                        <div class="panel-heading">
                ...
                <div class="col-sm-8 col-md-8 prof_list">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            ...
                            <h4 class="prof_name"><a href="#">Nguyễn Thị Vân</a></h4>
                            <span class="prof_title">Giảng Viên</span>   
                        </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/MaiKyTuyen.jpg')}}" alt=""/>
                                </div>
                            </div>
                            <h4 class="prof_name"><a href="http://fit.tdc.edu.vn/nhan-su/mai-ky-tuyen">Mai Kỷ Tuyên</a></h4>
                            <span class="prof_title">Giảng viên</span>
                ...
                <div class="col-sm-8 col-md-8 prof_list">
                    <div class="row">
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/TranThiMinhSa.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/NguyenNgocCamTu.jpg')}}" alt=""/>                  
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/NguyenPHongLan.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/DoanQuocThuan.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/HoangAnh.jpg')}}" alt=""/>
                                </div>
                            </div>
    ...
    <div class="type-318">
        <div class="container teacher">
            <div class="row">
                <!--COMPUTER NETWORK (M?NG M�Y T�NH)-->
                <div class="col-sm-4 col-md-4">
                    <div class="widget html">	
                        <div class="panel-heading">
                ...
                <div class="col-sm-8 col-md-8 prof_list">
                    <div class="row">
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/LeDienTam.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/NguyenNgocAnhMy.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/NguyenThanhVu.jpg')}}" alt=""/>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 placeholder profview">
                            <div class="profview_thumb">
                                <div class="profview_thumb_wrap">
                                    <img src="{{asset('front/images/NguyenThiMongHang.jpg')}}" alt=""/>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-6 col-sm-3 placeholder profview">
                        <div class="profview_thumb">
                            <div class="profview_thumb_wrap">
                                <img src="{{asset('front/images/CaoTranThaiAnh.jpg')}}" alt=""/>
                            </div>
                        </div>
    ...
    <div class="container news">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="{{asset('front/images/posts-1.jpg')}}" alt=""/>
                    </div>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="{{asset('front/images/posts-1.png')}}" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">                   
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="{{asset('front/images/posts-3.jpg')}}" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="{{asset('front/images/posts-4.png')}}" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="{{asset('front/images/posts-5.jpg')}}" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">                   
                <div class="top_news_block">
                    <div class="top_news_block_thumb">
                        <img src="{{asset('front/images/posts-6.jpg')}}" alt=""/>
                    </div>
                    <div class="top_news_block_desc">
                        <div class="row">
                            <div class="col-md-4 col-xs-3 topnewstime">
        ...
        <div class="pagination-centered">
            <ul class="pagination">
                ...
                <li class="next"><a href="#" data-ci-pagination-page="2" rel="next">3</a></li>
            </ul>    
        </div>
        <!--END PAGINATION-->
    </div>
